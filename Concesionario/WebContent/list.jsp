...
<div align="center" width="200%">
    ...
    <input type="button" value="Añadir" href="insert.jsp"/>
<% out.println("<a class='space' href='insert.jsp'> AÑADIR PARTICIPANTES </a>");  %>  
    </div>
<br>
<table border="1" borderColor="black" cellPadding="0" cellSpacing="0" width="920" height="80">
<tbody>
<td bgColor="cyan" width="150" align="center" height="19"><font color="red"><b>Posición</b></font></td>

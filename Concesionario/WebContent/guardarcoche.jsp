...
String capacidadMaletero=request.getParameter("capacidadMaletero");
...
int val3 = st.executeUpdate("INSERT coche "
        + "VALUES( '"+id+"', '"+numPuertas+"','"+capacidadMaletero+"')");
out.println("<body>");
con.close();
...
out.println("<tr><td>Puertas: " +"<b>"+ numPuertas +"</b>" + "</td></tr>");
out.println("<tr><td>Capacidad de Maletero: " +"<b>"+ capacidadMaletero +"</b>" + "</td></tr>");
out.println("<br>");
out.println("</table>");
out.println("<br>");
